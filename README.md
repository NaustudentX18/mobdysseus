...
**v0.1.0** — first working build: a native Kotlin + Jetpack Compose app with
streaming AI chat, local notes, and provider configuration.
...
| Settings + about | ✅ |
| On-device LLM (Cookbook port) | 🚧 planned (Phase 2) |
