...
private fun taskJson(value: Any): Task { val o = value as JSONObject; return Task(o.getString("id"), o.getString("title"), o.getBoolean("done")) }
...
private fun Task.toJson() = JSONObject().put("id", id).put("title", title).put("done", done)
